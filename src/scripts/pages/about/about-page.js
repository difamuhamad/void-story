export default class AboutPage {
  async render() {
    ...
    <section class="about__container">
      ...
      <p class="about__paragraph">
        While traditional feeds capture fleeting moments, StoryTale deciphers the narrative behind every pixel. Every story you share becomes part of a living archive — accessible across space-time, designed for dreamers who code their legacy.
      </p>
      <p class="about__paragraph">
      ...
      <footer class="about__footer">
        ...
        <div class="footer__copyright">
          &copy; 2025 VOID Story. All realities reserved.
        </div>
      </footer>
    </section>
    `;
